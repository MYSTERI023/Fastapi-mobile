...
Ram_GB = st.pills('Ram Size',[4,6,8,12,16,24])
Storage = st.pills('Storage Size',[32,64,128,256,512])
...
if Brand =='Apple':
    ...
    Vivo=0
    Xiaomi=1   
Proccessor = st.selectbox('Select Proccessor',['Apple_Bionic','Dimensity','Exynos','Snapdragon','Tensor'])
